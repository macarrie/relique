...
function Sidebar() {
    return (
        <>
            <aside className="fixed top-0 left-0 z-40 w-64 h-screen bg-base-200 flex flex-col">
                ...
                <div className="flex-grow px-3 pt-2 overflow-y-auto">
                ...
                <div className="px-3 pt-2 pb-2 overflow-y-auto">
                    <ul className="space-y-2 font-medium">
                        <SidebarMenuItem target="/config" icon="ri-settings-5-fill" label="Configuration" />
                    </ul>
                </div>
            </aside>
        </>
